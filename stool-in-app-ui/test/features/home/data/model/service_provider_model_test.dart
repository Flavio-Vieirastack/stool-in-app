...
void main() {
  ...
  test('Deve retornar o servicesToDo no servicesToExecute', () {
    final model = serviceProviderPayload
        ...
        .toList();
    final sut = model[0].servicesToExecuteModel;
    expect(sut[0].servicesTodo, 'Montar guarda roupa, montar mesa, montar armário de cozinha');
  });
  ...
  test('Deve retornar o userPhotoUrl no userData', () {
    final model = serviceProviderPayload
        ...
        .toList();
    final sut = model[0].userData;
    expect(sut.userPhotoUrl, 'https://love.doghero.com.br/wp-content/uploads/2018/12/golden-retriever-1.png');
  });
